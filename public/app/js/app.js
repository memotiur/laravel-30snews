!function (e, t, o) {
    var a = '[data-toggle="aside"]', n = e("body");
    ...
    function a(t, o) {
        ...
        t.fullCalendar({
            ...
            droppable: !0,
            drop: function (o, n) {
                var r = e(this), i = r.data("calendarEventObject");
                if (i) {
                    var s = e.extend({}, i);
    ...
    function n(t) {
        ...
        var a = "#f6504d", n = e(".external-event-add-btn"), r = e(".external-event-name"),
        ...
        e(".external-events-trash").droppable({
            ...
            var n = r.val();
            if ("" !== e.trim(n)) {
                var s = e("<div/>").css({"background-color": a, "border-color": a, color: "#fff"}).html(n);
    ...
    function r() {
        var e = new Date, t = e.getDate(), o = e.getMonth(), a = e.getFullYear();
        return [{
            title: "All Day Event",
    ...
    if (e.fn.fullCalendar) {
        var i = function (t) {
            t && t.each(function () {
                var t = e(this), o = {title: e.trim(t.text())};
                t.data("calendarEventObject", o), t.draggable({zIndex: 1070, revert: !0, revertDuration: 0})
            })
        };
        e(function () {
            var t = e("#calendar"), o = r();
            n(t), a(t, o)
        })
    }
}(jQuery, window, document), function (e, t, o) {
    e(function () {
        if (e.fn.dataTable) {
            ...
            }), o = "datatable_input_col_search", a = e("tfoot ." + o);
            a.keyup(function () {
    ...
    e(function () {
        var t = ".dropdown-toggle[data-play]", o = e(t).parent();
        o.on("show.bs.dropdown", function (t) {
            var o = e(this), a = o.children(".dropdown-toggle"), n = a.data("play"), r = a.data("duration") || .5,
    ...
    t.FlotChart = function (t, o) {
        this.element = e(t), this.url = o, this.requestData = function (t, o, a) {
            ...
            var e = this, t = this.element.parents(".panel").eq(0);
        ...
        !function () {
            var t = ".chart-bar";
            e(t).each(function () {
                var o = e(this).data("source") || e.error("Bar: No source defined."), a = new FlotChart(this, o),
                    n = (e(t).parents(".panel"), {
                        series: {
                            bars: {
                                align: "center",
            ...
            e(t).each(function () {
                var t = e(this).data("source") || e.error("Bar Stacked: No source defined."),
                    o = new FlotChart(this, t), a = {
                        series: {stack: !0, bars: {align: "center", lineWidth: 0, show: !0, barWidth: .6, fill: .9}},
                        grid: {borderColor: "#eee", borderWidth: 1, hoverable: !0, backgroundColor: "#fcfcfc"},
                        tooltip: !0,
                        tooltipOpts: {content: "%x : %y"},
                        xaxis: {tickColor: "#fcfcfc", mode: "categories"},
            ...
            var t = ".chart-area";
            e(t).each(function () {
                var t = e(this).data("source") || e.error("Area: No source defined."), o = new FlotChart(this, t), a = {
                    series: {lines: {show: !0, fill: .8}, points: {show: !0, radius: 4}},
                    grid: {borderColor: "#eee", borderWidth: 1, hoverable: !0, backgroundColor: "#fcfcfc"},
                    tooltip: !0,
                    tooltipOpts: {content: "%x : %y"},
                    xaxis: {tickColor: "#fcfcfc", mode: "categories"},
                    yaxis: {
                        tickColor: "#eee", tickFormatter: function (e) {
                            return e + " visitors"
                        }
                    },
                    shadowSize: 0
            ...
            var t = ".chart-line";
            e(t).each(function () {
                var t = e(this).data("source") || e.error("Line: No source defined."), o = new FlotChart(this, t), a = {
            ...
            var t = ".chart-pie";
            e(t).each(function () {
                var t = e(this).data("source") || e.error("Pie: No source defined."), o = new FlotChart(this, t), a = {
                    series: {
                        pie: {
                            show: !0,
                            innerRadius: 0,
                            label: {
                                show: !0, radius: .8, formatter: function (e, t) {
            ...
            var t = ".chart-donut";
            e(t).each(function () {
                var t = e(this).data("source") || e.error("Donut: No source defined."), o = new FlotChart(this, t),
                    a = {series: {pie: {show: !0, innerRadius: .5}}};
                o.requestData(a)
            })
        }()
    })
}(jQuery, window, document), function (e, t, o) {
    var a = [{featureType: "water", stylers: [{visibility: "on"}, {color: "#bdd1f9"}]}, {
        featureType: "all",
    ...
    }, {featureType: "road", stylers: [{color: "#d8dbe0", lightness: 20}]}], n = '[data-toggle="gmap"]';
    if (e.fn.gMap) {
        var r = [];
        e(n).each(function () {
            var t = e(this), o = t.data("address") && t.data("address").split(";"),
                n = t.data("title") && t.data("title").split(";"), i = t.data("zoom") || 14,
                s = t.data("maptype") || "ROADMAP", l = [];
            if (o) {
                for (var d in o) "string" == typeof o[d] && l.push({address: o[d], html: n && n[d] || "", popup: !0});
                var c = {
                    controls: {
                        panControl: !0,
                        zoomControl: !0,
                    ...
                    }, scrollwheel: !1, maptype: s, markers: l, zoom: i
                }, u = t.gMap(c), f = u.data("gMap.reference");
                r.push(f), void 0 !== t.data("styled") && f.setOptions({styles: a})
            }
        })
    }
    e(t).resize(function () {
    ...
    e.extend(a.prototype, {
        init: function () {
            ...
            var r = o.preview.parent(), i = this.code.find(".CodeMirror-sizer"),
                s = this.code.find(".CodeMirror-scroll").on("scroll", e.Utils.debounce(function () {
                    if ("tab" != o.markdownarea.attr("data-mode")) {
                        var e = i.height() - s.height(), t = r[0].scrollHeight - r.height(), a = t / e,
                            n = s.scrollTop() * a;
                        r.scrollTop(n)
                    }
                }, 10));
            ...
            var e = this, t = Object.keys(a.plugins), o = a.plugins;
                    ...
                    t.forEach(function (t) {
                        ...
                        n[a] = n[a].replace(o[t].identifier, function () {
                            var n = o[t].cb({
                                ...
                                replace: function (e) {
                                    var t = this.area.editor.getLine(this.line), o = t.indexOf(this.found[0]);
                                    end = o + this.found[0].length, this.area.editor.replaceRange(e, {
                                        line: this.line,
                                        ch: o
                                    }, {line: this.line, ch: end})
                                }
                            });
                            return n
                        })
    ...
    var n = function (e, t) {
        var o = t.getSelection(), a = e.replace("$1", o);
        t.replaceSelection(a, "end")
    };
    return a.commands = {
        fullscreen: {
            title: "Fullscreen", label: '<i class="fa fa-expand"></i>', action: function (a) {
                ...
                }, n.style.width = "", n.style.height = a.markdownarea.content.height() + "px", o.documentElement.style.overflow = "hidden"; else {
        ...
        bold: {
            title: "Bold", label: '<i class="fa fa-bold"></i>', shortcut: ["Ctrl-B", "Cmd-B"], action: function (e) {
                n("html" == this.getMode() ? "<strong>$1</strong>" : "**$1**", e)
            }
        },
        italic: {
            title: "Italic", label: '<i class="fa fa-italic"></i>', action: function (e) {
                n("html" == this.getMode() ? "<em>$1</em>" : "*$1*", e)
            }
        },
        strike: {
            title: "Strikethrough", label: '<i class="fa fa-strikethrough"></i>', action: function (e) {
                n("html" == this.getMode() ? "<del>$1</del>" : "~~$1~~", e)
            }
        },
        blockquote: {
            title: "Blockquote", label: '<i class="fa fa-quote-right"></i>', action: function (e) {
                n("html" == this.getMode() ? "<blockquote><p>$1</p></blockquote>" : "> $1", e)
            }
        },
        link: {
            title: "Link", label: '<i class="fa fa-link"></i>', action: function (e) {
                n("html" == this.getMode() ? '<a href="http://">$1</a>' : "[$1](http://)", e)
            }
        },
        picture: {
            title: "Picture", label: '<i class="fa fa-picture-o"></i>', action: function (e) {
                n("html" == this.getMode() ? '<img src="http://" alt="$1">' : "![$1](http://)", e)
            }
        },
        listUl: {
            title: "Unordered List", label: '<i class="fa fa-list-ul"></i>', action: function (e) {
                "markdown" == this.getMode() && n("* $1", e)
            }
        },
        listOl: {
            title: "Ordered List", label: '<i class="fa fa-list-ol"></i>', action: function (e) {
    ...
    e(function () {
        var t = '[data-toggle="navbar-search"]', a = '[data-toggle="navbar-search-dismiss"]',
            n = '.navbar-form input[type="text"]', r = e("form.navbar-form"), i = {
                toggle: function () {
                    r.toggleClass("open");
    ...
    function a(t) {
        var o = t.data("message"), a = t.data("options");
    ...
    var a = {}, n = {}, r = function (t) {
        return "string" == e.type(t) && (t = {message: t}), arguments[1] && (t = e.extend(t, "string" == e.type(arguments[1]) ? {status: arguments[1]} : arguments[1])), new s(t).show()
    }, i = function (e, t) {
        if (e)
            for (var o in n) e === n[o].group && n[o].close(t); else
        ...
        uuid: !1, element: !1, timout: !1, currentstatus: "", group: !1, show: function () {
            if (!this.element.is(":visible")) {
                ...
                return this.element.css({
                    ...
                    "margin-bottom": 0
                }).animate({opacity: 1, "margin-top": 0, "margin-bottom": t}, function () {
    ...
    var a = '[data-toggle="offsidebar"]', n = ".offsidebar", r = "offsidebar-open", i = e("body");
    e(function () {
        var t = {
            open: function (e) {
                i.addClass(r)
    ...
    e(o).on("click", a, function (t) {
        ...
        e.support.animation ? a.animo({animation: "bounceOut"}, o) : o()
    })
}(jQuery, window, document), function (e, t, o) {
    var a = '[data-perform="panel-collapse"]';
    e(a).each(function () {
        var t = e(this), o = t.closest(".panel"), a = o.find(".panel-wrapper"), n = {toggle: !1};
        ...
        var o = e(this).closest(".panel"), a = o.find(".panel-wrapper");
        a.collapse("toggle")
    })
}(jQuery, window, document), function (e, t, o) {
    function a() {
    ...
    var n = '[data-perform="panel-refresh"]', r = "panel-refresh", i = "csspinner", s = "standard";
    e(o).on("click", n, function (t) {
        var o = e(this), n = o.parents(".panel").eq(0), l = o.data("spinner") || s;
    ...
    e(function () {
        ...
        e(a).each(function () {
            function o(t) {
                !t.hasClass("anim-running") && e.Utils.isInView(t, {topoffset: n}) && (t.addClass("anim-running"), setTimeout(function () {
                    t.addClass("anim-done").animo({animation: i, duration: .7})
                }, r))
            }

            var a = e(this), n = a.data("offset"), r = a.data("delay") || 100, i = a.data("play") || "bounce";
            "undefined" != typeof n && (o(a), t.scroll(function () {
                o(a)
            }))
        }), e(o).on("click", a, function (t) {
            var o = e(this), a = o.data("target"), n = o.data("play") || "bounce", r = e(a);
            r && r && r.animo({animation: n})
        })
    })
}(jQuery, window, document), function (e, t, o) {
    if (e.fn.sortable) {
    ...
    var a = '[data-toggle="collapse-next"]', n = e(".sidebar .collapse").collapse({toggle: !1}), r = "aside-toggled",
        i = e("body"), s = 768;
    e(function () {
    ...
    var a = ".inlinesparkline",
        n = {primary: "#5fb5cb", success: "#27ae60", info: "#22bfe8", warning: "#ffc61d", danger: "#f6504d"};
    e(a).each(function () {
    ...
    e(a).on("change", function () {
        var t = e(this), o = t.index() + 1, a = t.find('input[type="checkbox"]'), n = t.parents("table");
    ...
    e(function () {
        e('[data-toggle="tooltip"]').tooltip({
            container: "body", placement: function (e, t) {
                var o = "top";
    ...
    e(function () {
        var t = e("#progressbar"), o = t.find(".progress-bar"), a = {
            action: "server/upload.php", allow: "*.(jpg|jpeg|gif|png)", param: "upfile", loadstart: function () {
    ...
    function a(t, o) {
        function r(t, o) {
            var a = new FormData, n = new XMLHttpRequest;
            if (o.before(o, t) !== !1) {
    ...
    var r = function (t, o) {
        var n = this, i = e(t), o = e.extend({}, a.defaults, r.defaults, o);
    ...
    r.defaults = {};
    var i = function (t, o) {
        var n = e(t), o = e.extend({}, a.defaults, i.defaults, o), r = !1;
    ...
    return i.defaults = {dragoverClass: "dragover"}, e.upload = {
        select: r,
        drop: i
    ...
    e(o).on("click", a, function (t) {
        t.stopPropagation();
        var o = e(this), a = o.find(".dropdown-menu > li > a").filter(t.target).html(), n = o.find(".btn");
    ...
    e.support.transition = function () {
        var e = function () {
            var e, t = o.body || o.documentElement, a = {
        ...
        var r = n.scrollLeft(), i = n.scrollTop(), s = a.offset(), l = s.left, d = s.top;
        return o = e.extend({
            topoffset: 0,
            leftoffset: 0
    ...
    e(t).load(function () {
        e(".scroll-content").slimScroll({height: "250px"})
    }), e(function () {
