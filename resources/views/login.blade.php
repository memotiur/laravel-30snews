                ...
                <div class="panel-body">
                    <form role="form" class="mb-lg" method="post" action="/login-check"
                        ...
                        <div class="form-group has-feedback">
                            <input id="exampleInputEmail1" type="text" placeholder="Username" value="memotiur"
                                   class="form-control" name="username">
                            <span class="fa fa-phone form-control-feedback text-muted"></span>
                        </div>
                        <div class="form-group has-feedback">
                            <input id="exampleInputPassword1" type="password" placeholder="Password" value="123456"
